...
- **FCS opponents:** assigned a generic FCS rating (two buckets: top-tier FCS ≈ −25, other FCS ≈ −35 vs average FBS). FCS teams are excluded from normal rating updates. Without this rule, Week 1 breaks the pipeline.
